...
export const cyberwareData: Record<string, Cyberware[]> = {
  'Frontal Cortex': [
    ...
    },
    {
      ...
      rarity: 'Iconic',
      stats: ['+100% Crit Chance with quickhacks', '-4 Max RAM'],
      capacity: 50
    },
    {
    ...
    },
    {
      ...
      rarity: 'Iconic',
      stats: ['Restores cyberware cooldown (max 50 sec)', '-15% Cooldown for all cyberware'],
      capacity: 45
    },
    {
      id: 'self-ice',
  ...
  'Operating System': [
    {
      ...
      rarity: 'Legendary',
      stats: ['16 RAM', '8 Slots', '-2 RAM cost Covert quickhacks', '+5 RAM after takedown'],
      capacity: 14
    },
    {
      id: 'biotech-sigma',
    ...
    {
      id: 'qiant-warp-dancer',
      name: 'QianT "Warp Dancer" Sandevistan',
      category: 'Operating System',
      description: 'Iconic Sandevistan with unique properties',
      rarity: 'Iconic',
  ...
  'Hands': [
    ...
    },
    {
      ...
      rarity: 'Iconic',
      stats: ['-35% recoil', '-25% bullet spread', 'Auto cover effects'],
      capacity: 35
    }
  ],
  'Nervous System': [
  ...
  'Integumentary System': [
    ...
    },
    {
      ...
      rarity: 'Iconic',
      stats: ['200 Armor', 'Additional Health Regen'],
      capacity: 50
    },
    {
      id: 'shock-n-awe',
